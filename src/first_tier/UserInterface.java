...
public class UserInterface {
	...
	public UniReminder addUniReminder () {
		...
		// Description
		String UrD = (JOptionPane.showInputDialog (null, "Describe the reminder :")).trim();  // trim() gets rid of leading & trailing whitespace
		u.setMessage (UrD);
		
		// Time
		String StringUTime = (JOptionPane.showInputDialog (null, "What time does " + UrN + " need to be completed by? (Use a . to seperate hours / minutes)")).trim();  // trim() gets rid of leading & trailing whitespace
		double UTime = Double.parseDouble(StringUTime);
		u.setTime (UTime);
		
		// Subject Name
		String UrS = (JOptionPane.showInputDialog (null, "What subject is" + UrN + "referring too? ")).trim();  // trim() gets rid of leading & trailing whitespace
		u.setSubject (UrS);
	...
	public PurchaseReminder addPurchaseReminder () {
		...
		// Description
		String PrD = (JOptionPane.showInputDialog (null, "Describe the reminder :")).trim();  // trim() gets rid of leading & trailing whitespace
		p.setMessage (PrD);
				
		// Time
		String StringPTime = (JOptionPane.showInputDialog (null, "What time does " + PrN + " need to be completed by? (Use a . to seperate hours / minutes)")).trim();  // trim() gets rid of leading & trailing whitespace
		double PTime = Double.parseDouble(StringPTime);
		p.setTime (PTime);
		
		// Description
		String PrI = (JOptionPane.showInputDialog (null, "What is the name of the item you need to purchase? ")).trim();  // trim() gets rid of leading & trailing whitespace
		p.setItem (PrI);
		...
		// Price
		String StringPPrice = (JOptionPane.showInputDialog (null, "Estimate how much " + PrI + " will cost: (seperate dollars and cents with a .)")).trim();  // trim() gets rid of leading & trailing whitespace
